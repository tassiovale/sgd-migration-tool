				...
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					...
					<tbody>
						<tr>
							<td>
								<div align="center">
									<strong>nCodigoDisciplina</strong>
								</div>
							</td>
							<td>
								<div align="center">
							...
							<td>
								<div align="center">
									<strong>LocalDisciplina</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>lFora_CETEC</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="Disciplina">
							<!-- Cache the current node incase the a field is formatted -->
							<xsl:value-of select="fx:CacheCurrentNode(.)"/>
							<tr>
								<td>
									<xsl:value-of select="nCodigoDisciplina"/>
								</td>
								<td>
									<xsl:value-of select="NomeDisciplina"/>
								</td>
								<td>
									<xsl:value-of select="LocalDisciplina"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('lFora_CETEC', 'Yes/No', '', '', 11)"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>

	...
	<xsl:template match="//dataroot" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		<html>
			<head>
				...
				<title>Tipo Colaboracao Esporadica</title>
				...
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					...
					<tbody>
						<tr>
							...
							<td>
								<div align="center">
									<strong>sDescricaoColaboracao</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>nSequenciaCHL</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="Tipo_x0020_Colaboracao_x0020_Esporadica">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="sDescricaoColaboracao"/>
								</td>
								<td>
									<xsl:value-of select="nSequenciaCHL"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>

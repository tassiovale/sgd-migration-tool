				...
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					...
					<tbody>
						<tr>
							...
							<td>
								<div align="center">
									<strong>DescricaoCargo</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>lTitular</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="Cargo_x0020_Area">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="DescricaoCargo"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('lTitular', 'Yes/No', '', '', 11)"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>

			...
			<body link="#0000ff" vlink="#800080">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						...
						<col style="TEXT-ALIGN: right; WIDTH: 2.38cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 2.38cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 3.227cm"/>
						<col style="WIDTH: 2.38cm"/>
						<col style="WIDTH: 2.38cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 2.38cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 2.38cm"/>
					...
					<tbody>
						<tr>
							<td>
								<div align="center">
									<strong>nCodigoDocente</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>nMatriculaSiape</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>sNomeDocente</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>dDataIngresso</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>nCodigoArea</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>lEntregouPTT</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>lAprovadoEstagio</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>dDataDesligamento</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>sMotivoDesligamento</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>OrigemDocente</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>nCodigoClasse</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>nCodigoNivel</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>nCodigoTitulacao</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>nCodigoOrigemVaga</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>sObsOrigemVaga</strong>
								</div>
							</td>
							<td>
								<div align="center">
							...
							<td>
								<div align="center">
									<strong>sObservacaoEstagio</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>nCargaHoraria</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>dDataIngressoCETEC</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>UtilizaraGabinete</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>nTelefone</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="Docente">
							...
							<tr>
								<td>
									<xsl:value-of select="nCodigoDocente"/>
								</td>
								<td>
									<xsl:value-of select="nMatriculaSiape"/>
								</td>
								<td>
									<xsl:value-of select="sNomeDocente"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('dDataIngresso', 'Short Date', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="nCodigoArea"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('lEntregouPTT', 'Yes/No', '', '', 11)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('lAprovadoEstagio', 'Yes/No', '', '', 11)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('dDataDesligamento', 'Short Date', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="sMotivoDesligamento"/>
								</td>
								<td>
									<xsl:value-of select="OrigemDocente"/>
								</td>
								<td>
									<xsl:value-of select="nCodigoClasse"/>
								</td>
								<td>
									<xsl:value-of select="nCodigoNivel"/>
								</td>
								<td>
									<xsl:value-of select="nCodigoTitulacao"/>
								</td>
								<td>
									<xsl:value-of select="nCodigoOrigemVaga"/>
								</td>
								<td>
									<xsl:value-of select="sObsOrigemVaga"/>
								</td>
								<td>
									<xsl:value-of select="sEmail"/>
								</td>
								<td>
									<xsl:value-of select="sObservacaoEstagio"/>
								</td>
								<td>
									<xsl:value-of select="nCargaHoraria"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('dDataIngressoCETEC', 'Short Date', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('UtilizaraGabinete', 'Yes/No', '', '', 11)"/>
								</td>
								<td>
									<xsl:value-of select="nTelefone"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>

	...
	<xsl:template match="//dataroot" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		<html>
			<head>
				...
				<title>ControleAvaliacaoDocente</title>
				...
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					...
					<tbody>
						<tr>
							...
							<td>
								<div align="center">
									<strong>DtEntregaArea</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>DtEntregaCurso</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>DtEntregaDiretor</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="ControleAvaliacaoDocente">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="nAvaliacao"/>
								</td>
								<td>
									<xsl:value-of select="nCodigoCurso"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('DtEntregaArea', 'Short Date', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('DtEntregaCurso', 'Short Date', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('DtEntregaDiretor', 'Short Date', '', '', 7)"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>

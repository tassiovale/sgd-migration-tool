	...
	<xsl:template match="//dataroot" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		<html>
			<head>
				...
				<title>Historico Cargo Curso</title>
			...
			<body link="#0000ff" vlink="#800080">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						...
						<col style="TEXT-ALIGN: right; WIDTH: 2.38cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 2.38cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 2.46cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 3.915cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 4.365cm"/>
					</colgroup>
					<tbody>
						<tr>
							<td>
								<div align="center">
									<strong>nCodigoCurso</strong>
								</div>
							</td>
							<td>
								<div align="center">
					...
					<tbody id="CTRL2">
						<xsl:for-each select="Historico_x0020_Cargo_x0020_Curso">
							<!-- Cache the current node incase the a field is formatted -->
							<xsl:value-of select="fx:CacheCurrentNode(.)"/>
							<tr>
								<td>
									<xsl:value-of select="nCodigoCurso"/>
								</td>
								<td>
									<xsl:value-of select="Sequencia"/>
								</td>
								<td>
									<xsl:value-of select="nCodigoDocente"/>
								</td>
								<td>
									<xsl:value-of select="nCodigoCargo"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Data_x0020_Inicio', 'Short Date', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Data_x0020_Fim', 'Short Date', '', '', 7)"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>

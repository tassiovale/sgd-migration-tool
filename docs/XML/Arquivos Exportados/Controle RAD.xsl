				...
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					...
					<tbody>
						<tr>
							...
							<td>
								<div align="center">
									<strong>EnvioCoordenador</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>DtEnvio</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="Controle_x0020_RAD">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="Mês_x002F_Ano"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Entregou', 'Yes/No', '', '', 11)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Data_x0020_Envio', 'Short Date', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('EnvioCoordenador', 'Yes/No', '', '', 11)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('DtEnvio', 'Short Date', '', '', 7)"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>

	...
	<xsl:template match="//dataroot" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		<html>
			<head>
				...
				<title>Motivo Afastamento</title>
				...
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					...
					<tbody>
						<tr>
							...
							<td>
								<div align="center">
									<strong>sDescricaoAfastamento</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="Motivo_x0020_Afastamento">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="sDescricaoAfastamento"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>

	...
	<xsl:template match="//dataroot" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		<html>
			<head>
				...
				<title>Colaboracao Esporadica</title>
				...
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					...
					<tbody>
						<tr>
							...
							<td>
								<div align="center">
									<strong>dDataInicio</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>dDataFinal</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>nCodigoColaboracao</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>sInformacaoAdicional</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="Colaboracao_x0020_Esporadica">
							<!-- Cache the current node incase the a field is formatted -->
							<xsl:value-of select="fx:CacheCurrentNode(.)"/>
							<tr>
								<td>
									<xsl:value-of select="nSequencia"/>
								</td>
								<td>
								...
								<td>
									<xsl:value-of select="sIFE"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('dDataInicio', 'Short Date', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('dDataFinal', 'Short Date', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="nCodigoColaboracao"/>
								</td>
								<td>
									<xsl:value-of select="sInformacaoAdicional"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>

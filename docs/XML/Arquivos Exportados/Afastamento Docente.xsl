	...
	<xsl:template match="//dataroot" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		<html>
			<head>
				...
				<title>Afastamento Docente</title>
			...
			<body link="#0000ff" vlink="#800080">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						...
						<col style="TEXT-ALIGN: right; WIDTH: 3.783cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 4.682cm"/>
						<col style="WIDTH: 21.507cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 3.359cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 2.38cm"/>
					</colgroup>
					<tbody>
						<tr>
							...
							<td>
								<div align="center">
									<strong>Interrompe Estágio</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>nCodigoMotivo</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="Afastamento_x0020_Docente">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Data_x0020_Inicio', 'Short Date', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Data_x0020_Final', 'Short Date', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="Motivo"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Interrompe_x0020_Estágio', 'Yes/No', '', '', 11)"/>
								</td>
								<td>
									<xsl:value-of select="nCodigoMotivo"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>

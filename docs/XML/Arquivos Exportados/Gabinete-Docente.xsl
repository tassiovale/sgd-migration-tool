				...
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					...
					<tbody>
						<tr>
							<td>
								<div align="center">
									<strong>nGabineteDocente</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>nCodigoGabinete</strong>
								</div>
							</td>
							<td>
								<div align="center">
							...
							<td>
								<div align="center">
									<strong>GabineteDirecao</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="Gabinete-Docente">
							<!-- Cache the current node incase the a field is formatted -->
							<xsl:value-of select="fx:CacheCurrentNode(.)"/>
							<tr>
								<td>
									<xsl:value-of select="nGabineteDocente"/>
								</td>
								<td>
									<xsl:value-of select="nCodigoGabinete"/>
								</td>
								<td>
									<xsl:value-of select="nCodigoDocente"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Titular', 'Yes/No', '', '', 11)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Afastado', 'Yes/No', '', '', 11)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('GabineteDirecao', 'Yes/No', '', '', 11)"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
